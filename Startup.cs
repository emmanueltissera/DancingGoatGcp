...
using DancingGoatGcp.Resolvers;
using DancingGoatGcp.Services;
...
namespace DancingGoatGcp
{
    ...
    {
        // This constant must match <UserSecretsId> value in DancingGoatGcp.csproj 
        public const string USER_SECRETS_ID = "DancingGoatGcp";
